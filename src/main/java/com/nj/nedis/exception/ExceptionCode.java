...
public class ExceptionCode {
    ...
    //参数行顺序错误
    public static final int CMD_ORDER_ERR = START  + 6;

    //参数行多余错误
    public static final int CMD_ARGS_EXCESS = START + 2;

    public static final int REPLY = 1000000000;

    public static final int REPLY_NOT_COMPLETE = 1000000000;
